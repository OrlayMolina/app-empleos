<x-guest-layout>
    <form method="POST" action="{{ route('register') }}" novalidate>
        ...
        <div class="mt-4">
            ...
            <select name="rol" id="rol" class="border-teal-600 focus:border-teal-500 focus:ring-indigo-500 rounded-md shadow-sm w-full">
                <option value="">-- selecctiona un rol --</option>
