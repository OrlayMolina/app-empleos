                ...
                @forelse ($vacantes as $vacante)
                    <div class="md:flex md:justify-between md:items-center py-5">
                        ...
                        <div class="md:flex-1">
                            ...
                            <p class="text-sm font-bold text-gray-600 mb-2">{{ $vacante->categoria->categoria}}</p>
                        ...
                        <div class="mt-5 md:mt-0">
                            <a class="bg-teal-600 p-3 text-sm 
                                uppercase font-bold text-white rounded-lg block text-center" href="{{ route('vacantes.show', $vacante->id) }}">Ver Vacantes</a>
                        </div>
                    </div>
                @empty
