<div class="p-10">
    <div class="mb-5">
        ...
        <div class="md:grid md:grid-cols-2 bg-gray-100 p-4">
    ...
    <div class="md:grid md:grid-cols-6 gap-6">
        ...
        <div class="md:col-span-4">
            <p  class="text-2xl font-bold mb-5">Descripción del Puesto</p>
    ...
    @guest
        <div class="mt-5 bg-gray-100 border border-dashed p-5 text-center">
            <p>
                ¿Deseas aplicar a esta vacante? <a class="font-bold text-teal-700" href="{{ route('register')}}">Obtén una cuenta y aplica a esta y otras vacantes</a>
            </p>
        </div><!-- fin de este div -->
    @endguest
